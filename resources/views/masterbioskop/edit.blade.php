...
@section('title', 'Cinema Name Edit')
...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>Cinema Name</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('nama_bioskop',$bioskop->nama_bioskop,['placeholder' => 'Cinema Name','class' => 'form-control '.($errors->has('nama_bioskop') ? 'is-invalid':''),'required'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('kota',$bioskop->kota,['placeholder' => 'Cities','class' => 'form-control '.($errors->has('kota') ? 'is-invalid':''),'required'])}}
                        @if ($errors->has('kota'))
