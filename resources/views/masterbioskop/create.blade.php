...
<div class="col-xxl">
    <div id="panel-1" class="panel">
        <div class="panel-hdr">
            <h2>Tambah Baru <span class="fw-300"><i>Bioskop </i></span></h2>
        ...
        <div class="panel-container show">
            <div class="panel-content">
                ...
                <div class="form-group col-md-4 mb-3">
                    ...
                    {{ Form::text('nama_bioskop',null,['placeholder' => 'Nama Bioskop','class' => 'form-control '.($errors->has('nama_bioskop') ? 'is-invalid':''),'required'])}}
                ...
                <div class="form-group col-md-4 mb-3">
                    ...
                    {{ Form::text('kota',null,['placeholder' => 'Kota','class' => 'form-control '.($errors->has('kota') ? 'is-invalid':''),'required'])}}
                    @if ($errors->has('kota'))
                ...
                <div class="form-group col-md-4 mb-3">
                    ...
                    {{ Form::text('pajak',null,['placeholder' => 'Pajak','class' => 'form-control '.($errors->has('pajak') ? 'is-invalid':''),'required'])}}
                    @if ($errors->has('pajak'))
