            ...
            <div class="panel-content">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('nama_perusahaan',$vendor->nama_perusahaan,['placeholder' => 'Nama Perusahaan','class' => 'form-control '.($errors->has('nama_perusahaan') ? 'is-invalid':''),'required', 'style' => 'text-transform: uppercase;'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::email('email',$vendor->email,['placeholder' => 'Email','class' => 'form-control '.($errors->has('email') ? 'is-invalid':''),'required'])}}
                        @if ($errors->has('email'))
