...
@section('title', 'Edit Master Film')

@section('content')
<div class="col-xxl">
    <div id="panel-1" class="panel">
        <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>Master Film</i></span></h2>
        ...
        <div class="panel-container show">
            <div class="panel-content">
                <div class="panel-tag">
                    Perubahan nama film akan diterapkan juga ke seluruh data pelaporan yang menggunakan film ini.
                </div>

                {!! Form::open(['route' => ['masterfilm.update', $masterFilm->uuid], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) !!}
                <div class="row">
                    <div class="form-group col-md-6 mb-3">
                        {{ Form::label('name', 'Nama Film', ['class' => 'required form-label']) }}
                        {{ Form::text('name', old('name', $masterFilm->name), [
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        <input type="date" name="tgl_tayang" value="{{old('tgl_tayang', optional($masterFilm->tgl_tayang)->format('Y-m-d'))}}"
