...
class CinepointDailyController extends Controller
{
    ...
    public function sync(CinepointDailyCollector $collector, CinepointRemoteSyncQueue $queue)
    {
        try {
            ...
            return redirect()->route('seatmap-monitor.index')->with('cinepoint_error', 'Sinkronisasi gagal; snapshot sukses sebelumnya tetap tersedia. Periksa konfigurasi collector dan database.');
        }
    }
