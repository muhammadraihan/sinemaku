...
use App\Http\Controllers\SeatmapMonitorController;
...
Route::group(['prefix' => 'backoffice', 'middleware' => ['auth']], function () {
    ...
    Route::get('audience-estimate', [SeatmapMonitorController::class, 'index'])->name('seatmap-monitor.index');
    Route::get('audience-estimate/ranking', [SeatmapMonitorController::class, 'ranking'])->name('seatmap-monitor.ranking');
    Route::get('audience-estimate/films/{film}', [SeatmapMonitorController::class, 'filmDetail'])->name('seatmap-monitor.films.show');
    Route::get('audience-estimate/timeline/{film}', [SeatmapMonitorController::class, 'timeline'])->name('seatmap-monitor.timeline');
    Route::get('audience-estimate/sources', [SeatmapMonitorController::class, 'sources'])->name('seatmap-monitor.sources');
    Route::post('audience-estimate/sources', [SeatmapMonitorController::class, 'storeSource'])->name('seatmap-monitor.sources.store');
    Route::post('audience-estimate/accounts', [SeatmapMonitorController::class, 'storeAccount'])->name('seatmap-monitor.accounts.store');
    Route::delete('audience-estimate/accounts/{account}', [SeatmapMonitorController::class, 'deleteAccount'])->name('seatmap-monitor.accounts.destroy');
